...
anyValue = 'String';
anyValue = true;
let numberType = anyValue;
let stringType = anyValue;
let booleanType = anyValue;
// unknow - 알 수 없는 타입
// 해당 변수에 입력을 할 수는 있지만,
// 같은 'unknown' 타입 또는 'any' 타입만 할당할 수 있다.
let anyValue2;
anyValue2 = 100;
anyValue2 = 'String';
anyValue2 = true;
...
let unknownType2 = anyValue2;
let anyType2 = anyValue2;
 ...
 * List Type
 */
const stringListType = ['아이브', '레드벨벳', '블랙핑크'];
const booleanListType = [true, false];
