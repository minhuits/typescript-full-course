...
let stringsOrNumbersArray: (string | number)[] = [ // string[] or number[]
    1,
    '2',
    3,
    '4',
...
let stringArrNumberArr: string[] | number[] = [ // string[] or number[]
    1,
    2,
    3,
]
...
let stringOrNumberArr: string | number[] = [ // string or number[]
    1, 2, 3
]
